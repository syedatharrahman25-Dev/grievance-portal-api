...
public class GrievanceService {
    ...
    @Transactional
    public GrievanceResponseDTO updateStatus(String refNumber, GrievanceStatus newStatus, String remarks, String officerName)
    {
        //Step 1: find GRIEVANCE by reference number

        Grievance grievance = grievanceRepository
                .findByReferenceNumber(refNumber)
                .orElseThrow(() -> new RuntimeException("Grievance not found: " + refNumber));
    ...
    public GrievanceResponseDTO trackByRefNumber(String refNumber)
    {
        Grievance g = grievanceRepository
                .findByReferenceNumber(refNumber)
                .orElseThrow(() -> new RuntimeException("Grievance not found with: " + refNumber));
